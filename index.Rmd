...
date: "`r Sys.Date()`"
author: 
 - name: Le Texier Marion
   affiliation: Université Rouen Normandie, UMR 6266 IDEES
...
<p class="center"> [<img src="figures/zip.png" width="50"/> **Télécharger les données**](https://github.com/rzine-reviews/rzine_spatiotemp/raw/main/data.zip) </p>  
...
Pour cela nous utiliserons la boucle `for()` qui permet de reproduire, en boucle, une serie de traitements. 
...
rref <- bibentry(
   bibtype = "misc",
   title = "Exploration spatio-temporelle d’objets géographiques ponctuels",
   author = person("Marion Le Texier"),
   journal = "Rzine",
   publisher = "FR CIST",
   year = 2021,
